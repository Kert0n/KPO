...
Согласованность - это не одно свойство, а семейство моделей. Для курса достаточно четырех.
...
Two-phase commit пытается приблизить распределенную операцию к обычной транзакции. Появляется координатор, который
разговаривает с участниками в две фазы.
