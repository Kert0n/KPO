...
::: multi-code "Конфигурация подключения"
...
::: multi-code "Unit of Work вокруг бизнес-операции"
...
Подборка закрывает две части лекции: эволюцию хранилищ данных и runtime-изоляцию через виртуализацию, контейнеры и Kubernetes.
...
- [Распределенный SQL: альтернатива шардированию](https://habr.com/ru/companies/ruvds/articles/714322/) — разбор distributed SQL.
- [Unit of Work и ORM](https://youtu.be/oP_OUiIK4Rc) — первые 15 минут про то, нужен ли Unit of Work при использовании ORM.

### Виртуализация и оркестрация

- [Самые основы виртуализации](https://habr.com/ru/articles/657677/) — вводное объяснение виртуализации простым языком.
