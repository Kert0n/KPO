...
::: multi-code "Контракт сообщения OrderCreated"
...
::: multi-code "Порт публикации сообщения" {playground=off}
...
::: multi-code "Очередь задач in-memory"
...
::: multi-code "Publish-subscribe in-memory"
...
::: multi-code "Идемпотентный consumer"
...
::: multi-code "Retry policy как чистая функция"
...
::: multi-code "Producer → Consumer: OrderCreated"
