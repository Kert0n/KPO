...
::: multi-code "Dual write: save → publish — точка отказа между ними"
...
::: multi-code "Idempotent consumer: оплата списывается один раз"
...
::: multi-code "Transaction Outbox: заказ и событие в одной локальной транзакции"
...
::: multi-code "Saga with compensation"
...
::: multi-code "Saga Orchestrator с журналом состояния"
